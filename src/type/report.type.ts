...
export const REPORT_REASONS: { value: ReportReason; label: string; description: string }[] = [
  ...
  },
  {
    ...
    description: 'Adult content, violence, or other unsuitable material',
  },
  {
    value: 'COPYRIGHT',
    label: 'Copyright Violation',
    description: 'Plagiarism or unauthorized use of copyrighted material',
  },
  {
    value: 'OFF_TOPIC',
    label: 'Off Topic',
    description: "Content that doesn't belong or is irrelevant",
  },
