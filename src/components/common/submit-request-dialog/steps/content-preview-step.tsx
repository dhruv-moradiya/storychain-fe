...
import type { StepProps, ChapterOption } from '../submit-request-dialog.types';

interface ContentPreviewStepProps extends StepProps {
  chapters: ChapterOption[];
}

export function ContentPreviewStep({ formData, chapters }: ContentPreviewStepProps) {
