...
import { BookOpen, PenTool, Bell, ChevronDown, Check } from 'lucide-react';

const tabs = [
  { key: 'stories', label: 'Stories', path: '/dashboard/stories', icon: BookOpen },
  { key: 'my-chapters', label: 'My Chapters', path: '/dashboard/my-chapters', icon: PenTool },
  { key: 'notification', label: 'Notifications', path: '/dashboard/notification', icon: Bell },
];
      ...
      <div className="bg-bg-cream/80 border-border/30 sticky top-0 z-50 w-full border-b backdrop-blur-xl">
        <div className="px-4 py-2">
          <ResponsiveDialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
              <ResponsiveDialogHeader>
                <ResponsiveDialogTitle>Dashboard Sections</ResponsiveDialogTitle>
              </ResponsiveDialogHeader>
